const beats=[{id:1,name:"Retroceder",cat:"trap",vibe:"Dark",bpm:132,price:"R$120",link:"https://pay.kiwify.com.br/0YaIpFV",img:"https://i.imgur.com/WjvDH0b.jpeg",file:"beats/retroceder.mp3"},
...
const wavesurfer=WaveSurfer.create({container:"#waveform",waveColor:"#222",progressColor:"#8a2be2",cursorColor:"#fff",barWidth:2,height:35,responsive:true});
...
<div class="beat-info-main"><h3>${b.name}</h3><span>${b.cat.toUpperCase()} • ${b.bpm} BPM</span></div>
...
<div class="price-area"><span class="price-tag">${b.price}</span><a href="${b.link}" class="btn-buy" target="_blank">COMPRAR</a></div>
</div>`});
}
